...
def detectPlatesInScene(imgOriginalScene):
    ...
    if recognizePlate.showSteps == True: # show steps #######################################################
    ...
    if recognizePlate.showSteps == True: # show steps #######################################################
        ...
        cv2.drawContours(imgContours, contours, -1, recognizePlate.SCALAR_WHITE)
    ...
    if recognizePlate.showSteps == True: # show steps #######################################################
        ...
        for i in range(0, len(listOfPossiblePlates)):
            ...
            cv2.line(imgContours, tuple(p2fRectPoints[0]), tuple(p2fRectPoints[1]), recognizePlate.SCALAR_RED, 2)
            cv2.line(imgContours, tuple(p2fRectPoints[1]), tuple(p2fRectPoints[2]), recognizePlate.SCALAR_RED, 2)
            cv2.line(imgContours, tuple(p2fRectPoints[2]), tuple(p2fRectPoints[3]), recognizePlate.SCALAR_RED, 2)
            cv2.line(imgContours, tuple(p2fRectPoints[3]), tuple(p2fRectPoints[0]), recognizePlate.SCALAR_RED, 2)
...
def findPossibleCharsInScene(imgThresh):
    ...
    for i in range(0, len(contours)):                       # for each contour
        ...
        if recognizePlate.showSteps == True: # show steps ###################################################
            cv2.drawContours(imgContours, contours, i, recognizePlate.SCALAR_WHITE)
        # end if # show steps #####################################################################
